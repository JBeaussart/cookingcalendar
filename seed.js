...
const recettes = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { item: "tomates cerises", quantity: null, unit: "selon taille du moule" },
      { item: "fromage râpé", quantity: null, unit: "au goût" },
      { item: "fromage à tartiner ail & fines herbes", quantity: null, unit: "au goût" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { item: "graines de sésame ou tournesol", quantity: null, unit: "optionnel" },
      { item: "paprika", quantity: 1, unit: "c. à café" },
